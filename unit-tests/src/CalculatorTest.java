...
public class CalculatorTest {
    ...
    public static void testCalculatingDiscount() {
        double result = Calculator.calculatingDiscount(1500.0, 50);
        Assertions.assertThat(result).isEqualTo(750.0);

        Assertions.assertThatThrownBy(() -> Calculator.calculatingDiscount(100.0, 0))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Покупка или скидка должны быть положительными");
    }
